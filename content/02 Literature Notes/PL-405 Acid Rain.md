...
artifact_id: PL-405
title: "Case Study #004 — Acid Rain Program (1990): Durable Success Through Market-Based Governance Design"
version: v1.1
status: Working
analytical_role: Success Validation Case
layer: Validation
owner: Project Loom
created: 2026-07-12
updated: 2026-07-12
...
related:
  ...
  - "[[PL-402 Case Study 001]]"
  - "[[PL-403 Case Study 002]]"
  - "[[PL-404 Case Study 003]]"
purpose: Test whether the ontology can explain a durable governance success using a market-based mechanism.
scope: Single case analysis. Focus on the 1990 Acid Rain Program (Title IV of the Clean Air Act Amendments).
---
...
**Policy Design Assessment:** Strong. The mechanism was well-matched to the objective. Unlike [[PL-404 Case Study 003|Cash for Clunkers]], where multiple objectives created tension, the Acid Rain Program had a clear primary objective (SO₂ reduction) and the mechanism was designed specifically to achieve it cost-effectively. The statute specified implementation architecture in unusual detail, reducing the gap between legislative intent and operational design.
...
**Key finding:** Low fragility in both dimensions is associated with durable implementation success—consistent with the pattern observed in [[PL-404 Case Study 003|Case #003]] and contrasting with Cases [[PL-402 Case Study 001|#001]] and [[PL-403 Case Study 002|#002]]. The program's low fragility was not accidental. It was designed in: bipartisan legislative origin reduced veto fragility; market mechanisms and automatic enforcement reduced execution fragility. This relationship requires additional testing.
...
The combination of low veto fragility and low execution fragility was mutually reinforcing. Political durability allowed the market to mature and compliance to proceed without disruption. Compliance success reinforced political durability by demonstrating that market-based regulation could achieve environmental goals. This virtuous cycle contrasts with the patterns observed in Cases [[PL-402 Case Study 001|#001]] and [[PL-403 Case Study 002|#002]], where fragility in one dimension cascaded into implementation failure.

### Diagnostic Classification

- [x] **Success** — Objectives achieved and exceeded. No single diagnostic classification is appropriate because no failure occurred. The framework performs successfully when it can identify the conditions that enabled success rather than defaulting to finding failure.
...
| Question | Response |
|----------|----------|
| Which ontology concepts were essential? | All core concepts were applied. [[PL-101 Project Loom Ontology#Entry 4 Governance Capacity|Governance Capacity]] (with domains), [[PL-101 Project Loom Ontology#Entry 5 Implementation Debt|Implementation Debt]], [[PL-101 Project Loom Ontology#Entry 7 Governance Fragility|Governance Fragility]], and [[PL-101 Project Loom Ontology#Entry 8 Dependency Concentration|Dependency Concentration]] were all necessary for the diagnosis. |
| Which concepts were unused? | [[PL-101 Project Loom Ontology#Entry 9 Formal vs. Effective Authority|Formal vs. Effective Authority]] was less critical—authority was aligned and effective. The concept remains valid but was not determinative in this case. |
...
>
> **Proposed Definition:** The accumulation of institutional knowledge, technical capability, administrative routines, regulatory precedent, and governance experience that increases future implementation capacity. Distinct from [[PL-101 Project Loom Ontology#Entry 4 Governance Capacity|Governance Capacity]] (which measures current ability) and [[PL-101 Project Loom Ontology#Entry 5 Implementation Debt|Implementation Debt]] (which measures accumulated weakness). Institutional Maturation asks: *How did the institution become capable?*
>
